...
exports.promoteOpaqueStructure = exports.getExtraDataTypeManager = void 0;
...
function getExtraDataTypeManager(session) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!sessionPriv.$$extraDataTypeManager) {
            ...
            yield client_dynamic_extension_object_1.populateDataTypeManager(session, extraDataTypeManager);
