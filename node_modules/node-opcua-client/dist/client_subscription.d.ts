...
export interface ClientSubscription extends EventEmitter {
    ...
    monitor(itemToMonitor: ReadValueIdOptions, requestedParameters: MonitoringParametersOptions, timestampsToReturn: TimestampsToReturn, done: (err: Error | null, monitoredItem?: ClientMonitoredItemBase) => void): void;
