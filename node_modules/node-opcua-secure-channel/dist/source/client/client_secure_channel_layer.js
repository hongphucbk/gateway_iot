 ...
 */
let ClientSecureChannelLayer = /** @class */ (() => {
    class ClientSecureChannelLayer extends events_1.EventEmitter {
        ...
        _on_message_received(response, msgType, requestId) {
            ...
            if (response.responseHeader.requestHandle !== requestId) {
                console.log(chalk.red.bgWhite.bold("xxxxx  <<<<<< _on_message_received  ERROR"), "requestId=", requestId, "response.responseHeader.requestHandle=", response.responseHeader.requestHandle, response.schema.name);
            }
            /* istanbul ignore next */
            if (doTraceMessage) {
    ...
    return ClientSecureChannelLayer;
})();
