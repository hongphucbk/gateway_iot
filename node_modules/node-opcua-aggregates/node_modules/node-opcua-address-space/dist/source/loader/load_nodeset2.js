...
exports.generateAddressSpace = exports.ensureDatatypeExtractedWithCallback = exports.ensureDatatypeExtracted = void 0;
/**
...
const node_opcua_xml2json_2 = require("node-opcua-xml2json");
...
function ensureDatatypeExtracted(addressSpace) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!addressSpacePriv.$$extraDataTypeManager) {
            ...
            yield node_opcua_client_dynamic_extension_object_1.populateDataTypeManager(session, dataTypeManager);
        }
...
function decodeXmlObject(addressSpace2, xmlEncodingNodeId, xmlBody) {
    return __awaiter(this, void 0, void 0, function* () {
        const dataTypeManager = yield ensureDatatypeExtracted(addressSpace2);
        ...
        const definitionMap = {
            findDefinition(name) {
                ...
                return dataTypeFactory.getStructuredTypeSchema(name);
            }
        };
        const reader = node_opcua_xml2json_2.makeExtensionObjectReader(dataTypeName, definitionMap, {});
        const parser2 = new node_opcua_xml2json_1.Xml2Json(reader);
        const pojo = yield parser2.parseString(xmlBody);
...
function makeStructureDefinition(name, definitionFields, isUnion) {
    // Structure = 0,
    ...
    const structureType = isUnion
        ...
        : (hasOptionalFields ? node_opcua_types_1.StructureType.StructureWithOptionalFields : node_opcua_types_1.StructureType.Structure);
...
function makeDefaultVariant2(addressSpace, dataTypeNode, valueRank) {
    ...
    if (nodeDataType) {
        ...
        const dv = node_opcua_factory_1.findSimpleType(node_opcua_variant_1.DataType[dataType]).defaultValue;
        let arrayType;
...
function generateAddressSpace(addressSpace, xmlFiles, callback) {
    ...
    const state_UADataType = {
        ...
        finish() {
            ...
            definitionFields = definitionFields.map((x) => {
                if (x.dataType) {
            ...
            const processBasicDataType = (addressSpace2) => __awaiter(this, void 0, void 0, function* () {
                node_opcua_assert_1.assert(!alreadyCalled);
                alreadyCalled = true;
                ...
                if (definitionFields.length) {
                    ...
                    if (isStructure /*&& dataTypeNode.nodeId.namespace !== 0*/) {
                        ...
                        dataTypeNode.$definition = makeStructureDefinition(definitionName, definitionFields, isUnion);
                    }
                    else if (isEnumeration /* && dataTypeNode.nodeId.namespace !== 0 */) {
                        dataTypeNode.$definition = makeEnumDefinition(definitionFields);
                    }
                    else {
                    }
                }
        ...
        parser: {
            ...
            References: references_parser,
            Definition: node_opcua_xml2json_2._definitionParser
        }
    };
    ...
    const _extensionObject_inner_parser = {
        ...
        Body2: new node_opcua_xml2json_2.FragmentClonerParser(),
        Body: {
            parser: {
            ...
            startElement(elementName, attrs) {
                ...
                if (!this.parser.hasOwnProperty(elementName)) {
                    ...
                    this._cloneFragment = new node_opcua_xml2json_2.InternalFragmentClonerReaderState();
            ...
            finish() {
                ...
                switch (self.typeDefinitionId.toString()) {
                    ...
                    default: {
                        ...
                        debugLog("loadnodeset2: typeDefinitionId in ExtensionObject Default XML = " + xmlEncodingNodeId.toString());
                        if (doDebug) {
                        ...
                        const task = (addressSpace2) => __awaiter(this, void 0, void 0, function* () {
                            const extensionObject = yield decodeXmlObject(addressSpace2, xmlEncodingNodeId, xmlBody);
                            if (postTaskData) {
                ...
                parser: {
                    String: {
                        finish() {
                            ...
                            if (!node_opcua_basic_types_1.isValidGuid(guid)) {
                                /* ?*/
                            }
    ...
    async.mapSeries(xmlFiles, (xmlFile, callback1) => {
        ...
        function finalSteps() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                /// ----------------------------------------------------------------------------------------
                debugLog(chalk.bgGreenBright("DataType extaction done ") + chalk.green("DONE"), err === null || err === void 0 ? void 0 : err.message);
        ...
        util_1.callbackify(finalSteps)((err1) => {
            if (err1) {
